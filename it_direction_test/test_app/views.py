...
def calculate_holland_type(responses):
    type_counts = {'Реалистичный тип': 0, 'Интеллектуальный тип': 0, 'Социальный тип': 0, 'Офисный (конвенциальный) тип': 0, 'Предпринимательский тип': 0, 'Артистический тип': 0}

    answer_key = {
        '1а': 'Реалистичный тип', '2а': 'Реалистичный тип', '3а': 'Реалистичный тип', '4а': 'Реалистичный тип', '5а': 'Реалистичный тип', '16а': 'Реалистичный тип', '17а': 'Реалистичный тип', '18а': 'Реалистичный тип', '19а': 'Реалистичный тип',
        '21а': 'Реалистичный тип', '31а': 'Реалистичный тип', '32а': 'Реалистичный тип', '33а': 'Реалистичный тип', '34а': 'Реалистичный тип',
        '1б': 'Интеллектуальный тип', '6а': 'Интеллектуальный тип', '7а': 'Интеллектуальный тип', '8а': 'Интеллектуальный тип', '9а': 'Интеллектуальный тип', '16б': 'Интеллектуальный тип', '20а': 'Интеллектуальный тип', '22а': 'Интеллектуальный тип', '23а': 'Интеллектуальный тип',
        '24а': 'Интеллектуальный тип', '31б': 'Интеллектуальный тип', '35а': 'Интеллектуальный тип', '36а': 'Интеллектуальный тип', '37а': 'Интеллектуальный тип',
        '2б': 'Социальный тип', '6б': 'Социальный тип', '10а': 'Социальный тип', '11а': 'Социальный тип', '12а': 'Социальный тип', '17б': 'Социальный тип', '29б': 'Социальный тип', '25а': 'Социальный тип', '26а': 'Социальный тип',
        '27а': 'Социальный тип', '36б': 'Социальный тип', '38а': 'Социальный тип', '39а': 'Социальный тип', '41б': 'Социальный тип',
        '3б': 'Офисный (конвенциальный) тип', '7б': 'Офисный (конвенциальный) тип', '10б': 'Офисный (конвенциальный) тип', '13а': 'Офисный (конвенциальный) тип', '14а': 'Офисный (конвенциальный) тип', '18б': 'Офисный (конвенциальный) тип', '22б': 'Офисный (конвенциальный) тип', '25б': 'Офисный (конвенциальный) тип', '28а': 'Офисный (конвенциальный) тип',
        '29а': 'Офисный (конвенциальный) тип', '32б': 'Офисный (конвенциальный) тип', '38б': 'Офисный (конвенциальный) тип', '40а': 'Офисный (конвенциальный) тип', '42а': 'Офисный (конвенциальный) тип',
        '4б': 'Предпринимательский тип', '8б': 'Предпринимательский тип', '11б': 'Предпринимательский тип', '13б': 'Предпринимательский тип', '15а': 'Предпринимательский тип', '23б': 'Предпринимательский тип', '28б': 'Предпринимательский тип', '30а': 'Предпринимательский тип', '33б': 'Предпринимательский тип',
        '35б': 'Предпринимательский тип', '37б': 'Предпринимательский тип', '39б': 'Предпринимательский тип', '40б': 'Предпринимательский тип',
        '5б': 'Артистический тип', '9б': 'Артистический тип', '12б': 'Артистический тип', '14б': 'Артистический тип', '15б': 'Артистический тип', '19б': 'Артистический тип', '21б': 'Артистический тип', '24б': 'Артистический тип', '27б': 'Артистический тип',
        '29б': 'Артистический тип', '30б': 'Артистический тип', '34б': 'Артистический тип', '41а': 'Артистический тип', '42б': 'Артистический тип'
    }
...
def holland_test_view(request, user_data_id):
    ...
    if request.method == "POST":
        ...
        personality_descriptions = {
            'Реалистичный тип': 'Активность, агрессивность, деловитость, настойчивость, рациональность, практическое мышление, развитые двигательные навыки, пространственное воображение, технические способности',
            'Интеллектуальный тип': 'Аналитический ум, независимость и оригинальность суждений, гармоничное развитие языковых и математических способностей, критичность, любознательность, склонность к фантазии, интенсивная внутренняя жизнь, низкая физическая активность',
            'Социальный тип': 'Умение общаться, гуманность, способность к сопереживанию, активность, зависимость от окружающих и общественного мнения, приспособление, решение проблем с опорой на эмоции и чувства, преобладание языковых способностей',
            'Офисный (конвенциальный) тип': 'Способности к переработке числовой информации, стереотипный подход к проблемам, консервативный характер, подчиняемость, зависимость, следование обычаям, конформность, исполнительность, преобладание математических способностей',
            'Предпринимательский тип личности': 'Энергия, импульсивность, энтузиазм, предприимчивость, агрессивность, готовность к риску, оптимизм, уверенность в себе, преобладание языковых способностей, развитые организаторские способности',
            'Артистический тип личности': 'Воображение и интуиция, эмоционально сложный взгляд на жизнь, независимость, гибкость и оригинальность мышления, развитые двигательные способности и восприятие'
        }
